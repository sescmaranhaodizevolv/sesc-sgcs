...
export function RealinhamentoPrecos() {
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="min-w-[140px]">Quantidade</TableHead>
                  <TableHead className="min-w-[140px]">Valor Original</TableHead>
                  <TableHead className="min-w-[140px]">Valor Solicitado</TableHead>
              ...
              <TableBody>
                {filteredRealinhamentos.map((realinhamento) => (
                  <TableRow key={realinhamento.id}>
                    <TableCell className="text-black sticky left-0 z-10">{realinhamento.empresa}</TableCell>
