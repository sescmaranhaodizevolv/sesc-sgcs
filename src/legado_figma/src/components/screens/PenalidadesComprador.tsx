...
import { Plus, Search, Archive, RotateCcw, Pencil, Paperclip, Shield, MoreVertical, Eye, Download, Clock, FileText, History } from 'lucide-react';
...
export function PenalidadesComprador() {
