...
export function AuditoriaRequisitante() {
  ...
  const todasNotificacoes = [
    {
      ...
      descricao: 'Sua requisição RC-2024-045 foi aprovada e está em processo de compra',
      data: '06/11/2024 14:35',
      status: 'Não Lida',
      icon: CheckCircle,
    ...
    },
    {
      id: 2,
      tipo: 'critical',
      titulo: 'Requisição Devolvida',
      descricao: 'RC-2024-043 foi devolvida. Motivo: Falta de especificações técnicas detalhadas',
      data: '06/11/2024 10:22',
      status: 'Não Lida',
      icon: AlertCircle,
    ...
    },
    {
      id: 3,
      tipo: 'warning',
      titulo: 'Requisição em Análise',
      descricao: 'Sua requisição RC-2024-044 está em análise pelo setor de compras',
      data: '05/11/2024 16:18',
      status: 'Não Lida',
      icon: Clock,
    ...
    },
    {
      ...
      tipo: 'info',
      titulo: 'Requisição Em Análise',
      descricao: 'RC-2024-042 está sendo analisada pelo comprador. Prazo estimado: 10/11/2024',
    ...
    },
    {
      ...
      descricao: 'A compra referente à sua requisição RC-2024-040 foi concluída com sucesso',
      data: '04/11/2024 15:30',
      status: 'Lida',
      icon: CheckCircle,
      iconColor: 'text-green-600',
      bgColor: 'bg-green-50'
    },
    {
      id: 6,
      tipo: 'info',
      titulo: 'Chamado de Suporte Respondido',
      descricao: 'Seu chamado #CH-2024-012 foi respondido pela equipe de suporte',
      data: '04/11/2024 11:20',
      status: 'Lida',
      icon: FileText,
    ...
    },
    {
      id: 7,
      tipo: 'warning',
      titulo: 'Informações Complementares Necessárias',
      descricao: 'A requisição RC-2024-041 necessita de informações adicionais sobre o fornecedor preferencial',
      data: '03/11/2024 14:15',
      status: 'Lida',
      icon: Clock,
      iconColor: 'text-yellow-600',
      bgColor: 'bg-yellow-50'
    },
    {
      id: 8,
      tipo: 'success',
      titulo: 'Requisição Criada com Sucesso',
      descricao: 'Sua requisição RC-2024-042 foi criada e enviada ao setor de compras',
      data: '01/11/2024 16:40',
      status: 'Lida',
      icon: CheckCircle,
      iconColor: 'text-green-600',
      bgColor: 'bg-green-50'
    },
    {
      id: 9,
      tipo: 'info',
      titulo: 'Atualização no Status',
      descricao: 'RC-2024-039 teve seu status atualizado para "Aguardando Aprovação Final"',
      data: '01/11/2024 09:30',
      status: 'Lida',
      icon: FileText,
      iconColor: 'text-blue-600',
      bgColor: 'bg-blue-50'
    },
    {
      id: 10,
      tipo: 'critical',
      titulo: 'Prazo de Complementação Expirando',
      descricao: 'Você tem até 08/11/2024 para complementar as informações da requisição RC-2024-038',
      data: '31/10/2024 15:20',
      status: 'Lida',
      icon: AlertCircle,
      iconColor: 'text-red-600',
      bgColor: 'bg-red-50'
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Histórico completo de notificações e atividades das suas requisições</p>
        </div>
            ...
            <Table>
              <TableHeader className="bg-[#003366] sticky top-0">
                <TableRow>
                  ...
                  <TableHead className="text-white min-w-[350px]">Descrição</TableHead>
