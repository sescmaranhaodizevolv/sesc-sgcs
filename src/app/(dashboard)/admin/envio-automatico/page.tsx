...
const todosProcessos: ProcessoEnvio[] = [
  { id: 1, idProcesso: "PROC-2024-005", empresa: "Empresa ABC Ltda", valorTotal: "R$ 28.500,00", statusAprovacao: "Aprovada", statusEnvio: "Enviado Automaticamente", dataEnvio: "25/01/2024 08:00", responsavel: "Sistema Automático", observacoes: "Processo enviado automaticamente ao fornecedor conforme configuração.", tipo: "Dispensa", classificacao: "normal" },
  { id: 2, idProcesso: "PROC-2024-008", empresa: "Tecnologia GHI Ltda", valorTotal: "R$ 35.200,00", statusAprovacao: "Aprovada", statusEnvio: "Enviado Automaticamente", dataEnvio: "25/01/2024 08:00", responsavel: "Sistema Automático", observacoes: "Envio automático executado com sucesso.", tipo: "Inexigibilidade", classificacao: "normal" },
  { id: 3, idProcesso: "PROC-2024-010", empresa: "Soluções JKL Corp", valorTotal: "R$ 42.800,00", statusAprovacao: "Aprovada", statusEnvio: "Enviado Automaticamente", dataEnvio: "24/01/2024 08:00", responsavel: "Sistema Automático", observacoes: "Processo enviado automaticamente.", tipo: "Licitação (Pesquisa de Preço)", classificacao: "normal" },
  { id: 4, idProcesso: "PROC-2024-032", empresa: "Fornecedor XYZ S.A", valorTotal: "R$ 31.400,00", statusAprovacao: "Aprovada", statusEnvio: "Aguardando Próxima Execução", dataEnvio: "26/01/2024 08:00", responsavel: "João Santos", observacoes: "Processo aprovado hoje. Será enviado na próxima execução automática às 08:00.", tipo: "Dispensa", classificacao: "normal" },
  { id: 5, idProcesso: "PROC-2024-033", empresa: "Comércio MNO Ltda", valorTotal: "R$ 27.900,00", statusAprovacao: "Aprovada", statusEnvio: "Aguardando Próxima Execução", dataEnvio: "26/01/2024 08:00", responsavel: "Maria Silva", observacoes: "Aguardando próxima execução automática.", tipo: "Dispensa", classificacao: "normal" },
  { id: 6, idProcesso: "PROC-2024-018", empresa: "Construção JKL Ltda", valorTotal: "R$ 38.500,00", statusAprovacao: "Aprovada", statusEnvio: "Bloqueado por Exceção", motivoBloqueio: "Pré-Contrato", dataBloqueio: "18/01/2024", dataAprovacao: "12/01/2024", responsavel: "João Santos", observacoes: "Criação de contrato pendente. Aguardando definição de cláusulas específicas antes do envio ao fornecedor.", tipo: "Inexigibilidade", classificacao: "pre-contrato" },
  { id: 7, idProcesso: "PROC-2024-027", empresa: "Serviços ABC Ltda", valorTotal: "R$ 42.300,00", statusAprovacao: "Aprovada", statusEnvio: "Bloqueado por Exceção", motivoBloqueio: "Pré-Contrato", dataBloqueio: "22/01/2024", dataAprovacao: "16/01/2024", responsavel: "Carlos Oliveira", observacoes: "Processo aguardando assinatura de contrato formal antes do envio automático.", tipo: "Licitação (Pesquisa de Preço)", classificacao: "pre-contrato" },
  { id: 8, idProcesso: "PROC-2024-031", empresa: "Limpeza XYZ Eireli", valorTotal: "R$ 35.600,00", statusAprovacao: "Aprovada", statusEnvio: "Bloqueado por Exceção", motivoBloqueio: "Pré-Contrato", dataBloqueio: "24/01/2024", dataAprovacao: "20/01/2024", responsavel: "Paula Mendes", observacoes: "Processo aguardando formalização de contrato antes do envio.", tipo: "Dispensa", classificacao: "pre-contrato" },
  { id: 9, idProcesso: "PROC-2024-035", empresa: "Consultoria MNO Ltda", valorTotal: "R$ 48.200,00", statusAprovacao: "Aprovada", statusEnvio: "Bloqueado por Exceção", motivoBloqueio: "Pré-Contrato", dataBloqueio: "23/01/2024", dataAprovacao: "18/01/2024", responsavel: "Ricardo Costa", observacoes: "Aguardando assinatura do contrato de prestação de serviços.", tipo: "Inexigibilidade", classificacao: "pre-contrato" },
  { id: 10, idProcesso: "PROC-2024-038", empresa: "Tecnologia RST S.A", valorTotal: "R$ 41.900,00", statusAprovacao: "Em Análise", statusEnvio: "Bloqueado por Exceção", motivoBloqueio: "Pré-Contrato", dataBloqueio: "25/01/2024", dataAprovacao: "-", responsavel: "Fernanda Lima", observacoes: "Processo em análise jurídica. Contrato em elaboração.", tipo: "Dispensa", classificacao: "pre-contrato" },
];
        ...
        <Dialog>
          ...
          <DialogContent className="max-w-md">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2"><Checkbox defaultChecked /><Label>Habilitar envio automático</Label></div>
