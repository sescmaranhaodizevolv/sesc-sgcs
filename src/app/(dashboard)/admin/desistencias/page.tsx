...
function HistoricoDesistencias() {
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  <SortableTableHead
                    label="Empresa"
                    onClick={() => sortDesistencias('empresa')}
                    currentDirection={configDesistencias?.key === 'empresa' ? configDesistencias.direction : null}
                    className="sticky left-0 z-10 min-w-[200px] bg-white"
                  />
                  <SortableTableHead
                    label="Processo"
                    onClick={() => sortDesistencias('processo')}
                    currentDirection={configDesistencias?.key === 'processo' ? configDesistencias.direction : null}
                    className="min-w-[120px]"
                  />
                  <SortableTableHead
                    label="Data"
                    onClick={() => sortDesistencias('dataDesistencia')}
                    currentDirection={configDesistencias?.key === 'dataDesistencia' ? configDesistencias.direction : null}
                    className="min-w-[120px]"
                  />
                  <SortableTableHead
                    label="Motivo"
                    onClick={() => sortDesistencias('motivo')}
                    currentDirection={configDesistencias?.key === 'motivo' ? configDesistencias.direction : null}
